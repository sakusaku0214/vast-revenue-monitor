...
be entered twice; a mismatch stops installation. After the Weekly Goal and Detailed
Report questions, select `1`/`en` for English or `2`/`ja` for Japanese; pressing
Enter selects English. Input is hidden, including the
