...
Hourly is a rolling sum of positive balance deltas whose observation timestamps are
within the preceding 60 minutes, so restarts and irregular 58/62-minute polling do
not change its definition. Daily assigns a positive delta to the business day that
