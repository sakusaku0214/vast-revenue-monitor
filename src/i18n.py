...
CATALOG = {
    "en": {
        ...
        "hourly": "Latest interval", "daily": "Today", "yesterday": "Yesterday", "weekly": "This week", "monthly": "This month",
        "weekly_goal": "Weekly Goal", "current": "Current", "goal": "Goal",
        "progress": "Progress", "remaining_goal": "Remaining to Goal",
        "all_time_high": "ATH", "ath_hourly": "Hourly", "ath_daily": "Daily",
        "ath_weekly": "Weekly", "ath_monthly": "Monthly",
    ...
    "ja": {
        ...
        "progress": "進捗", "remaining_goal": "目標まで残り", "all_time_high": "ATH",
        "ath_hourly": "時間", "ath_daily": "日間", "ath_weekly": "週間", "ath_monthly": "月間",
